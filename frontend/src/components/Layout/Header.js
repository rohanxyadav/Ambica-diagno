      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          <Link to="/" className="flex items-center space-x-2" data-testid="logo-link">
            ...
            <div>
              <h1 className="text-xl font-heading font-bold text-primary">Ambica</h1>
              <p className="text-xs text-slate-600">Diagnostic Center</p>
            </div>
          </Link>
            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  className="block w-full text-left py-2 text-slate-600 hover:text-primary"
                >
                  Logout
                </button>
              </>
